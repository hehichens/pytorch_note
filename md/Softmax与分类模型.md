...
plt.imshow(feature.view(28, 28).numpy(), cmap="gray")
plt.show()
```
...
<img src="https://cdn.kesci.com/rt_upload/E35B37B4A94A44AA89722155E8AB5788/q5ov8e9wnu.svg">
...
```
    ...
    <PIL.Image.Image image mode=L size=28x28 at 0x7FEA2FDCD978>
...
X, y = [], []
for i in range(10):
    X.append(mnist_train[i][0]) # 将第i个feature加到X中,即图片
    y.append(mnist_train[i][1]) # 将第i个label加到y中，即标签名字
show_fashion_mnist(X, get_fashion_mnist_labels(y))
```


<img src="https://cdn.kesci.com/rt_upload/056F457B00454FFD81A3CB6AD966C508/q5ov8fq6z3.svg">
...
```
    ...
    tensor([[0.2247, 0.1332, 0.2611, 0.1987, 0.1824],
            [0.1855, 0.3382, 0.2010, 0.1348, 0.1406]]) 
...
```
    ...
    epoch 1, loss 0.7878, train acc 0.749, test acc 0.791
    epoch 2, loss 0.5700, train acc 0.814, test acc 0.811
    epoch 3, loss 0.5267, train acc 0.825, test acc 0.815
...
<img src="https://cdn.kesci.com/rt_upload/1DA8927186304BEBA2B3DCC4A9E027DD/q5ov9vqvor.svg">
...
```
    ...
    epoch 1, loss 0.0031, train acc 0.749, test acc 0.773
    epoch 2, loss 0.0022, train acc 0.814, test acc 0.791
